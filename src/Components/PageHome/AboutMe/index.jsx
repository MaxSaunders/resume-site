            ...
            <div>
                ...
                <div className={`read-more show-${show}`}>
                    <div ref={readMoreRef} className='text-start mb-0'>
                        ...
                        <div className='mb-3'>
                            {`You can reach me at `}
                            <a title='EMAIL Me' className='primary-purple email-link d-inline fw-bold' href={`mailto:max@saunders.wiki`} style={{ cursor: 'pointer' }}>
                                {`max@saunders.wiki. `}
                            </a>
                        </div>
                        <div>
                            ...
                            <div className='fw-bold close-button read-more-button' onClick={toggleShow}>
                                CLOSE
                            </div>
                        </div>
                    </div>
