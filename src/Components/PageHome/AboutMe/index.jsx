...
const AboutMe = () => {
    ...
    const _show = async () => {
        await toggleShow()
        readMoreRef.current.scrollIntoView(true)
    }
        ...
        <div className='about-me-container section'>
            ...
            <div className='text-start mb-0 fs-5'>
                ...
                <div className='mb-4'>
                    ...
                    <div className='read-more-button' onClick={_show}>
                        READ MORE
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                className={`read-more ${show ? '' : 'read-more-hidden'}`}
            >
                <div ref={readMoreRef} className='text-start mb-0'>
                    ...
                    <div>
                        ...
                        <span className='primary-purple fw-bold'>
